  ...
  return (
    <header className="flex items-center justify-between py-4 sm:py-8">
      <div className="flex items-center">
        <CheckCircle2
          aria-hidden="true"
          className="h-8 w-8 sm:h-10 sm:w-10 mr-2 transition-transform duration-300 hover:scale-110 text-[var(--color-brand-primary)] dark:text-[var(--color-brand-primary)]"
        />
      ...
      <div className="flex items-center">
        <SignedIn>
          ...
          >
            <Button
              className="rounded-full w-8 h-8 sm:w-10 sm:h-10 p-0 shadow-md transition-all duration-300 bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-primary)] hover:shadow-[var(--color-brand-primary)]/50 text-[var(--color-text-inverse)]"
            ...
            <Button
              className={`rounded-full w-8 h-8 sm:w-10 sm:h-10 p-0 shadow-md transition-all duration-300 text-[var(--color-text-inverse)] ${
                isHabitsOverviewMode
                  ? "bg-[var(--color-brand-secondary)] shadow-[var(--color-brand-secondary)]/50"
                  : "bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-primary)] hover:shadow-[var(--color-brand-primary)]/50"
              }`}
            ...
            <UserButton
              appearance={{
                elements: {
                  userButtonAvatarBox:
                    "min-w-8 min-h-8 sm:min-w-10 sm:min-h-10 shadow-md transition-all duration-300 hover:bg-[var(--color-brand-primary)] hover:shadow-[var(--color-brand-primary)]/50",
                },
              }}
            />
          </div>
