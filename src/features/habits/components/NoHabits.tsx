...
export default function NoHabits({
  ...
  return (
    ...
    >
      ...
      <p
        className={`${isDarkMode ? "text-purple-400" : "text-purple-600"} mt-2`}
      >
        Try adding a new habit to start tracking your daily progress, or check a
        different date to view existing habits. Building good habits is the
