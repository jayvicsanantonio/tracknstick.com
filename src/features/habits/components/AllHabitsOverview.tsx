...
export default function AllHabitsOverview() {
  ...
  // Removed toggleisHabitsOverviewMode as this page is a dedicated route
  ...
  const filteredHabits = habits.filter((habit) => {
    ...
    if (selectedTab === "completed") return matchesSearch && !!habit.endDate; // Assuming 'completed' means habit has an endDate
