...
export default function AddHabitDialog({
  ...
  const [isAddingHabit, toggleIsAddingHabit] = useToggle(false);
  return (
    <Dialog open={isAddingHabit} onOpenChange={toggleIsAddingHabit}>
      ...
      >
        ...
        <div className="h-[608px] sm:h-[508px] grid gap-4 py-4">
          ...
          />
          <DialogFooter className="flex justify-end sm:justify-end items-center flex-row gap-2">
